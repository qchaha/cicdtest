  ...
  return _c('app-container', {
    ...
    attrs: {
      ...
      "imageList": [{
        ...
        'width': '900px',
        'height': '368px',
        'route': 'meijiabang://customer_service?content_title=&content_business=%E5%95%86%E5%9F%8E&content_act=&content_tags='
      }, {
        'imageSrc': 'http://cdn3.meijiabang.cn/public/upload/obj_image/2018/04/13/7047e15b81293602eaeb47cfb7c8f35a8Ak448.PNG',
        'width': '750px',
        'height': '1334px',
        'route': 'meijiabang://home_recommend?tag=%e8%af%9d%e9%a2%98&subtag=%e6%96%b0%e6%89%8b&content_title=&content_business=%E5%95%86%E5%9F%8E&content_act=&content_tags='
      }, {
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	methods: {
		jumpRoute: function jumpRoute() {
			...
			this.$emit('report', appRoute);
			if (appRoute) {
				this.$module('mjb-native').route(appRoute);
			}
		}
	}
});
