<?php
//用户唯一key
define('WEBSCAN_U_KEY', 'e89b27621257c68142441b853c6e884d');
//数据回调统计地址
...
$webscan_white_url = array('index.php' => 'm=admin','post.php' => 'job=postnew&step=post','edit_space_info.php'=>'','v1/api/images.json'=>'','rest.php/api/images.json'=>'');
?>